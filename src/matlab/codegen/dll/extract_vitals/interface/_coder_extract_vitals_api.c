...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *block_size,
  ...
  const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(block_size), &thisId);
 ...
 * Return Type  : void
 */
void extract_vitals_api(const mxArray *prhs[2], const mxArray *plhs[2])
{
  ...
  block_size = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "block_size");

  /* Invoke the target function */
  extract_vitals(frames, block_size, &hr, &rr);
