              ...
              emxArray_real_T *c)
{
  ...
  if (!((c->size[0] == 0) || (c->size[1] == 0))) {
    ...
    emxEnsureCapacity((emxArray__common *)av, i8, (int)sizeof(double));
    a_idx_0 = (unsigned int)b->size[0];
    i8 = bv->size[0];
    bv->size[0] = (int)a_idx_0;
    emxEnsureCapacity((emxArray__common *)bv, i8, (int)sizeof(double));
    bsub = 1;
    bk = 0;
    nc1 = c->size[0];
    i8 = c->size[0] * c->size[1] - c->size[0];
    ck = 0;
            ...
            emxArray_int32_T *c)
{
  ...
  c->size[0] = csz_idx_0;
  c->size[1] = csz_idx_1;
  emxEnsureCapacity((emxArray__common *)c, i7, (int)sizeof(int));
  if (!((c->size[0] == 0) || (c->size[1] == 0))) {
    emxInit_int32_T1(&av, 1);
    a_idx_0 = (unsigned int)a->size[0];
    i7 = av->size[0];
    av->size[0] = (int)a_idx_0;
    emxEnsureCapacity((emxArray__common *)av, i7, (int)sizeof(int));
    bsub = 1;
    bk = 0;
    nc1 = c->size[0];
    i7 = c->size[0] * c->size[1] - c->size[0];
    ck = 0;
