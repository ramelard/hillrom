  ...
  sintabinv, emxArray_creal_T *y)
{
  ...
  if (n1 > x->size[0]) {
    ...
    emxEnsureCapacity((emxArray__common *)y, i8, (int)sizeof(creal_T));
    minNrowsNx = y->size[1];
    for (i8 = 0; i8 < minNrowsNx; i8++) {
      xidx = y->size[0];
      for (b_k = 0; b_k < xidx; b_k++) {
        y->data[b_k + y->size[0] * i8].re = 0.0;
        y->data[b_k + y->size[0] * i8].im = 0.0;
      }
    }
  }
  ...
  while (k + 1 <= (int)sx[1]) {
    ...
    i8 = rwork->size[0];
    rwork->size[0] = n1;
    emxEnsureCapacity((emxArray__common *)rwork, i8, (int)sizeof(creal_T));
    xidx = x->size[0];
    if (n1 > xidx) {
      xidx = rwork->size[0];
      i8 = rwork->size[0];
      ...
      emxEnsureCapacity((emxArray__common *)rwork, i8, (int)sizeof(creal_T));
      for (i8 = 0; i8 < xidx; i8++) {
        rwork->data[i8].re = 0.0;
        rwork->data[i8].im = 0.0;
      }
    }
    ...
    i8 = fy->size[0];
    emxEnsureCapacity((emxArray__common *)fy, i8, (int)sizeof(creal_T));
    minNrowsNx = fy->size[0];
    for (i8 = 0; i8 < minNrowsNx; i8++) {
      wwc_re = fy->data[i8].re;
      wwc_im = fy->data[i8].im;
      fv_re = fv->data[i8].re;
      fv_im = fv->data[i8].im;
      fy->data[i8].re = wwc_re * fv_re - wwc_im * fv_im;
      fy->data[i8].im = wwc_re * fv_im + wwc_im * fv_re;
    }
    ...
    if ((int)varargin_1 > x->size[0]) {
      ...
      for (N2blue = 0; N2blue < nRows; N2blue++) {
        ...
        for (i7 = 0; i7 < loop_ub; i7++) {
          y->data[i7 + y->size[0] * N2blue].re = 0.0;
          y->data[i7 + y->size[0] * N2blue].im = 0.0;
        }
      }
    }
  } else {
