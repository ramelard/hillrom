              ...
              emxArray_real_T *c)
{
  ...
  if (!((c->size[0] == 0) || (c->size[1] == 0))) {
    ...
    emxEnsureCapacity((emxArray__common *)bv, i6, (int)sizeof(double));
    bsub = 1;
    bk = 0;
    nc1 = c->size[0];
    i6 = c->size[0] * c->size[1] - c->size[0];
    ck = 0;
            ...
            emxArray_int32_T *c)
{
  ...
  c->size[0] = csz_idx_0;
  c->size[1] = csz_idx_1;
  emxEnsureCapacity((emxArray__common *)c, i5, (int)sizeof(int));
  if (!((c->size[0] == 0) || (c->size[1] == 0))) {
    emxInit_int32_T1(&av, 1);
    a_idx_0 = (unsigned int)a->size[0];
    i5 = av->size[0];
    av->size[0] = (int)a_idx_0;
    emxEnsureCapacity((emxArray__common *)av, i5, (int)sizeof(int));
    bsub = 1;
    bk = 0;
    nc1 = c->size[0];
